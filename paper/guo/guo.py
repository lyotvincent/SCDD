...
s_dataPath = ['data/guo.raw.tsv',
            ...
            'results/scIGANs/scIGANs_guo_impute.tsv' ]
...
# plot for paga
figa, axsa = plt.subplots(3, 3, figsize=(9,9),constrained_layout=True)
generate_figures(s_dataPath, label, s_mtName, (3, 3), axsa, type="paga")
figa.savefig("paper/guo/guo_umap1.pdf")